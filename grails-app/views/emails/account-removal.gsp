...
<tr>
<td height="120" bgcolor="#7cd6f8" class="cellMargin"><a href="#" target="blank"> <img src="spine-logo.gif" width="235" height="80" border="0"></a></td>
</tr>
<tr border="0">
<td  height="30" bgcolor="#a0dded" ></td>
</tr>
<tr>
<td height="500" valign="top" class="cellMargin"> <BR/><h1>Attention!</h1>
<h2>You`ve just requested  <BR/>
an account removal.</h2><BR/><BR/>
<div class="callToAction"><a href="#" target="blank">Click here to remove your account</a></div>
...
Your won't be removed if you don't click the link above.<BR/>
<BR/>
